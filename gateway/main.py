...
app.include_router(user_settings_router, prefix="/service/gateway", tags=["User And Settings"])
app.include_router(payment_booking_router, prefix="/service/gateway", tags=["Payment And Booking"])